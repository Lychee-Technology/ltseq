...
class TestJoinBasic:
    ...
    def test_join_creates_ltseq(self):
        ...
        t1 = LTSeq.read_csv("examples/users.csv")
        t2 = LTSeq.read_csv("examples/orders.csv")
        result = t1.join(t2, on=lambda a, b: a.id == b.user_id)
    ...
    def test_join_left(self):
        ...
        t1 = LTSeq.read_csv("examples/users.csv")
        t2 = LTSeq.read_csv("examples/orders.csv")
        result = t1.join(t2, on=lambda a, b: a.id == b.user_id, how="left")
    ...
    def test_join_right(self):
        ...
        t1 = LTSeq.read_csv("examples/users.csv")
        t2 = LTSeq.read_csv("examples/orders.csv")
        result = t1.join(t2, on=lambda a, b: a.id == b.user_id, how="right")
    ...
    def test_join_full(self):
        ...
        t1 = LTSeq.read_csv("examples/users.csv")
        t2 = LTSeq.read_csv("examples/orders.csv")
        result = t1.join(t2, on=lambda a, b: a.id == b.user_id, how="full")
...
class TestJoinErrors:
    ...
    def test_join_missing_schema_raises_error(self):
        ...
        t1 = LTSeq()
        t2 = LTSeq.read_csv("examples/users.csv")
        with pytest.raises(ValueError, match="Schema not initialized"):
            t1.join(t2, on=lambda a, b: a.id == b.id)
    ...
    def test_join_invalid_how_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Invalid join type"):
            t1.join(t2, on=lambda a, b: a.id == b.user_id, how="invalid")
    ...
    def test_join_invalid_table_raises_error(self):
        ...
        with pytest.raises(TypeError, match="must be LTSeq"):
            t1.join("not a table", on=lambda a, b: a.id == b.id)
...
class TestJoinSchema:
    ...
    def test_join_result_has_columns_from_both_tables(self):
        ...
        assert "name" in result_df.columns or "name_other" in result_df.columns
        # Check that we have columns from orders
        assert "product" in result_df.columns or "amount" in result_df.columns
    ...
    def test_join_result_is_chainable(self):
        ...
        # Should be able to chain other operations
        filtered = result.filter(lambda r: r.amount > 0)
...
class TestJoinRegression:
    ...
    def test_join_does_not_modify_source(self):
        ...
        _ = t1.join(t2, on=lambda a, b: a.id == b.user_id)
    ...
    def test_join_multiple_calls(self):
        ...
        result1 = t1.join(t2, on=lambda a, b: a.id == b.user_id)
        result2 = t1.join(t2, on=lambda a, b: a.id == b.user_id, how="left")

...
class TestMathOnWindowExpressions:
    ...
    def test_round_method_rounds_the_receiver(self, sorted_numbers):
        ...
        assert self._derived(sorted_numbers, lambda r: r.val.shift(1).round(1)) == [
            3.1,
            2.7,
            -1.5,
        ]
    ...
    def test_round_method_default_decimals(self, sorted_numbers):
        assert self._derived(sorted_numbers, lambda r: r.val.shift(1).round()) == [
            3.0,
            3.0,
            -2.0,
        ]
    ...
    def test_abs_method(self, sorted_numbers):
        ...
        assert self._derived(sorted_numbers, lambda r: (r.x - r.x.shift(1)).abs()) == [
            13,
            3,
            7,
        ]
    ...
    def test_abs_builtin(self, sorted_numbers):
        assert self._derived(sorted_numbers, lambda r: abs(r.x - r.x.shift(1))) == [
            13,
            3,
            7,
        ]
    ...
    def test_floor_and_ceil_methods(self, sorted_numbers):
        assert self._derived(sorted_numbers, lambda r: r.val.shift(1).floor()) == [
            3.0,
            2.0,
            -2.0,
        ]
        assert self._derived(sorted_numbers, lambda r: r.val.shift(1).ceil()) == [
            4.0,
            3.0,
            -1.0,
        ]

...
class WhenChain:
    def when(self, condition: Expr, value: Any = ...) -> WhenChain | _WhenThen: ...
    def otherwise(self, default: Any) -> CallExpr: ...

class _WhenThen:
    def then(self, value: Any) -> WhenChain: ...

def when(condition: Expr, value: Any = ...) -> WhenChain | _WhenThen: ...
...
# Shared by Expr.__bool__ and the group dialect (GroupExpr / FilterExpr).

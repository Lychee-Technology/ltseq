...
class SQLPartitionedTable:
    def __init__(self, ltseq_instance: LTSeq, columns: tuple[str, ...]) -> None: ...
...
class PartitionedTable:
    def __init__(self, ltseq_instance: LTSeq, partition_fn: Callable[[LTSeq], LTSeq] | Callable[..., Any]) -> None: ...
    def __getitem__(self, key: Any) -> LTSeq: ...
    def __iter__(self) -> Iterator[LTSeq]: ...
    def __len__(self) -> int: ...
    def keys(self) -> list[Any]: ...

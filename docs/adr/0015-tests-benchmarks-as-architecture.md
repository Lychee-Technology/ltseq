...
Model the system with a fourth layer — **validation & performance** (`py-ltseq/tests/`, `benchmarks/`, the autoresearch workflow) — alongside API, orchestration, and execution.
